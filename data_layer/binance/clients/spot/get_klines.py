...
if __name__ == "__main__":
    ...
    for ticker in SYMBOL:
        ...
        path = f"/Users/giuliomannini/Hedge-Room/data/binance/spot/ohlc/{INTERVAL}/{ticker}" # /home/homercrypton/hedge-room/data/binance/spot/ohlc/1m/

        df, path, total_klines,\
        warmup_jobs, rtt_s,\
        target_workers= get_klines(ticker, INTERVAL, START, END, path, per_request_limit=1000)
