...
from binance.concurrency.network.spot_throttle import spot_throttle, SpotWeights, PerpFuturesWeights
...
# Binance /fapi/v1/klines returns list of rows shaped like:
