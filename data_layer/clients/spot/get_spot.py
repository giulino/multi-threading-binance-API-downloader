...
async def get_klines(
    ...
    """
    Download spot klines and persist to Parquet.
    ...
    async with HttpClient(
        ...
        async def process_result(res: HttpResult, job: Dict[str, Any]) -> None:
...
async def main():
    ...
    SYMBOL = ["ZECUSDC", "SAPIENUSDT", "SUIUSDT", "FDUSDUSDT", "USDCUSDT", "ETHBTC", "SOLUSDC"]
    INTERVAL = "1m"
    ...
    for ticker in SYMBOL:
        ...
        df, parquet_path, target_workers, total_jobs, average_usage = await get_klines(
            ticker,
            INTERVAL,
            START,
            END,
